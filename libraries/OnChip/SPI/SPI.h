...
private:
	...
	DMA_Channel_TypeDef* dmaTxChannel;				//dma通道
...
/*-------SPI Pin Configuration------*/
	...
	uint16_t       mCSNPin;    	//CSN gpio pin
	uint16_t       mSCKPin;     //SCK gpio pin
	uint16_t       mMISOPin;    //MISO gpio pin
	uint16_t       mMOSIPin;    //MOSI gpio pin
