...
u8 NRF24L01::SendData(uint8_t *pbuffer, uint32_t size){
...
//uint8_t NRF24L01::NRF_Read_IRQ(void){
//	return GPIO_ReadInputDataBit(IRQPin.mPort, IRQPin.mSelectPin);
//}
